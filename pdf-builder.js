// PDF BUILDER — Sprechen B2 Klimaschutz
(function () {
    ...
    function buildTheory() {
        ...
        t = t.replace(/<div class="theory-box"\s+style="background:\s*#F5F0E8[^"]*"[^>]*>/g, '<div class="theory-box warn-box">');
        return `<h1 class="chapter">📘 1. Teorie — Vocabular Klimaschutz (B2 Sprechen)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex3Data !== 'undefined') {
            html += fillInBlock('Übung 3 — Vocabular Klimaschutz în context (substantive cheie)', 'Klimawandel, Umweltverschmutzung, Treibhauseffekt, erneuerbare Energien, Mülltrennung, CO2-Emissionen.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillInBlock('Übung 4 — Verbe + adverbe pentru opinie (sollte, müsste, könnte)', 'Konjunktiv II pentru recomandări: „Wir sollten weniger Auto fahren." · „Die Regierung müsste mehr investieren."', ex4Data);
        }
